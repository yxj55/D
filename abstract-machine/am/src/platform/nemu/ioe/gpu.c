...
void __am_gpu_config(AM_GPU_CONFIG_T *cfg) {
  ...
  uint32_t h = screen_wh & 0xffff;//取低16位，去掉高16位
  uint32_t w = screen_wh >> 16;//取高16位,去掉低16位
  *cfg = (AM_GPU_CONFIG_T) {
